...
declare module '$env/static/private' {
	export const PREPR_GRAPHQL_URL: string;
	export const NODE_ENV: string;
	export const npm_package_dependencies__preprio_toolkit: string;
	...
	export const npm_config__preprio_registry: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		PREPR_GRAPHQL_URL: string;
		NODE_ENV: string;
		npm_package_dependencies__preprio_toolkit: string;
		...
		npm_config__preprio_registry: string;
